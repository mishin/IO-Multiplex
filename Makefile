# This Makefile is for the IO::Multiplex extension to perl.
#
...
#     ABSTRACT_FROM => q[lib/IO/Multiplex.pm]
#     BUILD_REQUIRES => {  }
#     CONFIGURE_REQUIRES => {  }
#     NAME => q[IO::Multiplex]
#     PREREQ_PM => { IO::Socket=>q[0] }
#     TEST_REQUIRES => {  }
#     VERSION_FROM => q[lib/IO/Multiplex.pm]
#     dist => { COMPRESS=>q[gzip -vf] }
...
PERL_LIB = C:\Users\TOSH\Documents\job\perl\strawberry-perl-5.20.0.1-32bit-PDL\perl\lib
...
PERL = "C:\Users\TOSH\Documents\job\perl\strawberry-perl-5.20.0.1-32bit-PDL\perl\bin\perl.exe"
...
INST_LIBDIR      = $(INST_LIB)\IO
INST_ARCHLIBDIR  = $(INST_ARCHLIB)\IO
...
TO_INST_PM = lib/IO/Multiplex.pm

PM_TO_BLIB = lib/IO/Multiplex.pm \
...
Multiplex.def: Makefile.PL
	$(PERLRUN) -MExtUtils::Mksymlists \
     -e "Mksymlists('NAME'=>\"IO::Multiplex\", 'DLBASE' => '$(BASEEXT)', 'DL_FUNCS' => {  }, 'FUNCLIST' => [], 'IMPORTS' => {  }, 'DL_VARS' => []);"
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) "abstract: 'Manage IO on many file handles'" >> META_new.yml
	...
	$(NOECHO) $(ECHO) "name: IO-Multiplex" >> META_new.yml
	...
	$(NOECHO) $(ECHO) "   \"abstract\" : \"Manage IO on many file handles\"," >> META_new.json
	...
	$(NOECHO) $(ECHO) "   }}," >> META_new.json
	$(NOECHO) $(ECHO) "   \"name\" : \"IO-Multiplex\"," >> META_new.json
	...
	$(NOECHO) $(ECHO) "         \"requires\" : {{" >> META_new.json
	$(NOECHO) $(ECHO) "            \"IO::Socket\" : \"0\"" >> META_new.json
	$(NOECHO) $(ECHO) "         }}" >> META_new.json
	$(NOECHO) $(ECHO) "      }}" >> META_new.json
	$(NOECHO) $(ECHO) "   }}," >> META_new.json
...
ppd :
	...
	$(NOECHO) $(ECHO) "    <ABSTRACT>Manage IO on many file handles</ABSTRACT>" >> $(DISTNAME).ppd
...
pm_to_blib : $(FIRST_MAKEFILE) $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e "pm_to_blib({{@ARGV}}, '$(INST_LIB)\auto', q[$(PM_FILTER)], '$(PERM_DIR)')" -- \
	  lib/IO/Multiplex.pm blib\lib\IO\Multiplex.pm 
